...
class DashboardController extends GetxController {
  ...
  void updateGreeting() {
    ...
    greeting.value = (hour < 11)
        ? "Selamat Pagi, Pejuang Pangan!"
        : (hour < 15)
        ? "Selamat Siang, Semangat!"
        : (hour < 18)
        ? "Selamat Sore, Pak Tani!"
  ...
  void fetchWeather() async {
    ...
    try {
      ...
      UiUtils.showError("Gagal memuat cuaca: $e");
    } finally {
  ...
  void generateSmartTips() {
    ...
    var generalTips = [
      {
        "title": "Info Pasar",
        "body": "Harga cabai rawit stabil Rp 45.000/kg.",
      ...
      {
        "title": "Tips Budidaya",
        "body": "Rotasi dengan jagung memutus siklus kutu.",
